...
public class ItemCargoTrain extends Item implements IItemRegisterEvent {
    private static final IBehaviorDispenseItem CARGO_TRAIN_DISPENSER_BEHAVIOR = new BehaviorDefaultDispenseItem() {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            EntityCargoTrain entityCargoTrain = new EntityCargoTrain(world, d0, d1 + d3, d2);

            if (stack.hasDisplayName()) {
                entityCargoTrain.setCustomNameTag(stack.getDisplayName());
            }

            world.spawnEntity(entityCargoTrain);
            stack.shrink(1);
            return stack;
        }
    ...
    public ItemCargoTrain(String name) {
        ...
        BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(this, CARGO_TRAIN_DISPENSER_BEHAVIOR);
    }
